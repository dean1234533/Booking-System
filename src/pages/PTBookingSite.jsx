...
export default function PTBookingSite({ profile, barber, reviews = [], bookingWidgetMount }) {
  ...
  return (
    <div className="pt-site bg-zinc-50 text-zinc-900 antialiased font-sans scroll-smooth min-h-screen">
      
      {/* STICKY STYLED NAVIGATION */}
      <header className="pt-header sticky top-0 z-50 w-full border-b border-zinc-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between p-4 md:px-8">
          ...
          <div>
            <a 
              ...
              className="pt-btn-red inline-block rounded bg-red-600 px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white select-none transition-all duration-75 active:translate-y-[2px] active:shadow-none shadow-[0_4px_0_#991b1b]"
            >
              Book Consultation
            </a>
          </div>
      ...
      <section className="pt-hero relative flex min-h-[85vh] items-center justify-center bg-zinc-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center md:px-8">
          <span className="pt-text-red inline-block rounded bg-red-600/20 px-3 py-1 text-xs font-bold uppercase tracking-widest text-red-400 border border-red-600/30 mb-4">
            Outdoor Performance Coaching
          </span>
          <h1 className="pt-h2 text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl leading-tight">
            {heroTitle}
          </h1>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a 
              href="#booking-section" 
              className="pt-btn-red w-full rounded bg-red-600 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white transition-all duration-75 active:translate-y-[2px] active:shadow-none shadow-[0_5px_0_#991b1b] sm:w-auto text-center"
            >
              Get Started Free
            </a>
            <a 
              ...
              className="pt-btn-dark flex w-full items-center justify-center gap-2 rounded bg-zinc-800 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white border border-zinc-700 transition-all duration-75 active:translate-y-[2px] active:shadow-none shadow-[0_5px_0_#374151] sm:w-auto"
            >
      ...
      <section id="about" className="pt-section mx-auto max-w-7xl px-4 py-24 md:px-8 transition-all duration-1000 transform motion-safe:opacity-100">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <span className="pt-text-red text-xs font-bold uppercase tracking-widest text-red-600">The Program</span>
            <h2 className="pt-h2 mt-2 text-3xl font-extrabold tracking-tight text-zinc-900 sm:text-4xl">
      ...
      <section id="services" className="pt-section bg-zinc-100 py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="text-center mb-12">
            <span className="pt-text-red text-xs font-bold uppercase tracking-widest text-red-600">Training Capabilities</span>
            <h2 className="pt-h2 mt-2 text-3xl font-extrabold tracking-tight text-zinc-900 sm:text-4xl">Expertise Options</h2>
          </div>

          <div className="pt-grid grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="pt-card rounded-xl bg-white p-8 border border-zinc-200 shadow-sm">
      ...
      <section id="reviews" className="bg-zinc-950 py-24 text-white">
        <div className="mx-auto max-w-6xl px-4 md:px-8">
          ...
          {reviews.length === 0 ? (
            ...
            <div className="pt-grid grid gap-6 md:grid-cols-2">
              {reviews.map((rev) => (
                <div key={rev.id} className="pt-card rounded-xl bg-zinc-900 p-8 border border-zinc-800 flex flex-col justify-between">
                  <div>
      ...
      <section id="booking-section" className="pt-section bg-white py-24 border-t border-zinc-200">
        <div className="mx-auto max-w-4xl px-4 md:px-8">
          <div className="text-center mb-12">
            <h2 className="pt-h2 text-3xl font-extrabold tracking-tight">Claim Your Time Slot</h2>
